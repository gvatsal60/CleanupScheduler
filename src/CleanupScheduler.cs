    ...
    try {
      ...
      using (TaskService ts = new TaskService()) {
        ...
        td.RegistrationInfo.Description =
            "Cleanup Temporary Files and Flush DNS";
        ...
        td.Actions.Add(
            new ExecAction("cmd.exe", "/c del /Q /S %temp%\\*.* 2>nul",
                           null)); // Commands to cleanup temporary files
        ...
        td.Actions.Add(new ExecAction(
            ...
            "Internet Files\\*.* 2>nul",
            null));
        td.Actions.Add(new ExecAction("cmd.exe", "/c ipconfig /flushdns",
                                      null)); // Command to flush DNS cache
        ...
        const string folderPath =
            "\\MyTask"; // Change this to your desired folder path
